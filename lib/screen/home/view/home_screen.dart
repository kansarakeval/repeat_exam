                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style:  TextStyle(fontSize: 18,),overflow: TextOverflow.visible,maxLines: 1
                    ),
                    const SizedBox(height: 5,),
                    Text(
                    ...
                    Align(
                      ...
                      child: Row(
                        ...
                        children: [
                          IconButton(
                            onPressed: () {
                              Get.to(() => EditScreen(editModel: controller.editList[index]));
                            },
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Description : ${controller.editList[index].description}",
                      style: const TextStyle(fontSize: 18),overflow: TextOverflow.visible,maxLines: 1,
                    ),
                    const SizedBox(height: 5,),
                    Text(
                      "Category : ${controller.editList[index].category}",
